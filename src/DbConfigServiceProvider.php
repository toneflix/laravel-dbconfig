...
use Toneflix\DbConfig\Commands\ConfigCreate;
use Toneflix\DbConfig\Commands\ConfigPurge;
use Toneflix\DbConfig\Commands\ConfigSet;
use Toneflix\DbConfig\Commands\ConfigShow;
use Toneflix\DbConfig\Commands\ConfigSync;
    ...
    public function boot()
    {
        if ($this->app->runningInConsole()) {
            ...
            AboutCommand::add('Laravel DbConfig', static fn () => array_filter([
                'Version' => InstalledVersions::getPrettyVersion('toneflix/laravel-dbconfig'),
